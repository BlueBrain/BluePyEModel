...
import getpass
import os
from bluepyemodelnexus.export_emodel import export_emodels_nexus
...
githash = "YOUR_GITHASH_HERE" # githash of the local emodel (provided during the optimization step).
