...
Then, to run the extraction, inform the name of the emodel in ``./extract.sh`` and execute the file. Please make sure that the name of the emodel matches an entry of the file ``recipes.json``.
...
To do so, inform your emodel name and githash in ``./analysis.sh`` and execute it.
...
If you wish to interact with the models, please have a look at the notebook `./notebooks/exploit_models.ipynb <./notebooks/exploit_models.ipynb>`_.
