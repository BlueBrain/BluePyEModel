...
- validation_function (str or list, default: 'max_score'): if str, can be "max_score" or "mean_score". If list, must contain the path to the file containing the function and name of the function. E.g: validation_function = ["path_to_module", "name_of_function"].
